RegisterServerEvent('4srp-banking:server:Transfer')
AddEventHandler('4srp-banking:server:Transfer', function(citizenid, target, account, amount, note, uuid)
    local src = source
    ...
    if (account == "business") then
        ...
        if data then
            ...
            TriggerEvent('4srp-banking:society:server:WithdrawMoney', src, amount, society)
            Wait(50)

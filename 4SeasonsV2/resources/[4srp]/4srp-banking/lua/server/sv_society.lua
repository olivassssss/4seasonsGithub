...
RegisterNetEvent('4srp-banking:society:server:WithdrawMoney')
AddEventHandler('4srp-banking:society:server:WithdrawMoney', function(pSource, a, n)
    local src = pSource
...
RegisterServerEvent('4srp-banking:society:server:DepositMoney')
AddEventHandler('4srp-banking:society:server:DepositMoney', function(pSource, a, n)
    local src = pSource
    if not src then return end

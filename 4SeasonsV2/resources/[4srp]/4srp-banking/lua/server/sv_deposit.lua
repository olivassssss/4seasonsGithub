RegisterServerEvent('4srp-banking:server:Deposit')
AddEventHandler('4srp-banking:server:Deposit', function(account, amount, note, uuid)
    local src = source
    ...
    if account == "business"  then
        ...
        if data then
            ...
            TriggerEvent('4srp-banking:society:server:DepositMoney', src, deposit, data.name)

...
RegisterNUICallback('showBlur', function()
    Wait(50)
    TriggerEvent("4srp-inventory:client:showBlur")
end)

RegisterNetEvent("4srp-inventory:client:showBlur", function()
    Wait(50)
...
local function CreateItemDrop(index)
	...
	if Config.UseTarget then
		exports['4srp-target']:AddTargetEntity(dropItem, {
			options = {
				{
...
RegisterNetEvent("4srp-inventory:client:closeinv", function()
    closeInventory()
end)
...
RegisterNetEvent('4srp-inventory:client:giveAnim', function()
...
CreateThread(function()
    if Config.UseTarget then
        exports['4srp-target']:AddTargetModel(Config.VendingObjects, {
            options = {
                {
...
CreateThread(function()
    if Config.UseTarget then
        exports['4srp-target']:AddTargetModel(Config.CraftingObject, {
            options = {
                {

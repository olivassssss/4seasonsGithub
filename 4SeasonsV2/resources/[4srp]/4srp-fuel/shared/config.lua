...
Config.FuelTargetExport = false -- This is only used to fix this issue: https://github.com/CodineDev/4srp-fuel/issues/3. <br> <br> If you don't have this issue and haven't installed this exports in 4srp-target, then this should be false. Otherwise there will be an error.
Config.InventoryBusy = true -- When true, the inventory state will be set to busy while refuelling. If needed, set this to false if incountering the following issue: https://github.com/CodineDev/4srp-fuel/issues/6 
-- Syphoning --

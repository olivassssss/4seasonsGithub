...
FS.Spawns = {
    ...
    ["paleto2"] = {
        ...
        pos = {top = 57.6, left = 28.7},
    },
}

FS.SpawnAccess = { --To disable the buttons
    ['apartments'] = true,
    ['houses'] = true,
    ['lastLoc'] = true,
}
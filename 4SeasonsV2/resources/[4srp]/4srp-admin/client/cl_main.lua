LoggedIn, QBCore = false, exports['4srp-core']:GetCoreObject()
...
RegisterCommand('adminmenu', function(source, args, RawCommand) TriggerEvent('4srp-admin/client/try-open-menu', true) end, false)

-- [ Events ] --

RegisterNetEvent('4srp-admin/client/try-open-menu', function(OnPress)
...
RegisterNetEvent('4srp-admin/client/force-close', function()
...
RegisterNUICallback('Admin/ToggleFavorite', function(Data, Cb)
    ...
    SetKvp("4srp-adminmenu-favorites", json.encode(Config.FavoritedItems), "Favorites")
    Cb('Ok')
end)

RegisterNUICallback('Admin/TogglePinnedTarget', function(Data, Cb)
    Config.PinnedTargets[Data.Id] = Data.Toggle
    SetKvp("4srp-adminmenu-pinned_targets", json.encode(Config.PinnedTargets), "Targets")
    Cb('Ok')
end)

RegisterNUICallback('Admin/ToggleSetting', function(Data, Cb)
    Config.AdminSettings[Data.Id] = Data.Toggle
    SetKvp("4srp-adminmenu-settings", json.encode(Config.AdminSettings), "Settings")
    Cb('Ok')
end)

RegisterNUICallback('Admin/GetCharData', function(Data, Cb)
    QBCore.Functions.TriggerCallback('4srp-admin/server/get-player-data', function(PlayerData)
        Cb(PlayerData)
    end, Data.License)
end)

...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    disable = false
    TriggerServerEvent('4srp-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('4srp-weathersync:client:EnableSync', function()
    disable = false
    TriggerServerEvent('4srp-weathersync:server:RequestStateSync')
end)

RegisterNetEvent('4srp-weathersync:client:DisableSync', function()
	disable = true
...
RegisterNetEvent('4srp-weathersync:client:SyncWeather', function(NewWeather, newblackout)
    CurrentWeather = NewWeather
    blackout = newblackout
end)

RegisterNetEvent('4srp-weathersync:client:SyncTime', function(base, offset, freeze)
    freezeTime = freeze
    timeOffset = offset
    baseTime = base
end)
